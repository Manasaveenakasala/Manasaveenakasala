...
<!--
  ...
  1) Make one in Canva (1200x300 works well) with your name + role.
  2) Upload it to this repo (Add file -> Upload files) as e.g. "banner.png".
  3) Uncomment the line below and it will show at the very top.
-->
<!-- <img src="https://raw.githubusercontent.com/Manasaveenakasala/Manasaveenakasala/main/banner.png" alt="Manasa Veena banner" width="100%"/> -->

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=61DAFB&center=true&vCenter=true&width=800&height=60&lines=Hi+%F0%9F%91%8B+I'm+Manasa+Veena;Software+Engineer+II;React+%C2%B7+Node.js+%C2%B7+Azure+%C2%B7+AI+Enthusiast" alt="Typing SVG" />
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:manasaui10@gmail.com)
...
- 💻 **Software Engineering:** React, Angular, TypeScript, JavaScript, Next.js, Node.js, Redux, SQL
- ☁️ **Cloud & Development:** Azure, AWS, Docker, Git
- 🤖 **Currently Exploring:** Generative AI, LLM applications, RAG systems, and AI-powered experiences
- 🚀 I enjoy solving complex technical problems, learning emerging technologies, and building products that combine great software engineering with the possibilities of AI
